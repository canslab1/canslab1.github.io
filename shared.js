...
const honorsEn = [
    ...
    '<span class="honors-highlight">Laosong Elementary School, Taipei City</span><br>2025.10 Total donations over the past four academic years exceeded NT$1,000,000<br>2025.09 Donated NT$500,000 on Teachers&#39; Day to improve the teaching environment and enhance the well-being of teachers and students <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-donation-1.jpg\')">Photo 1</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-donation-2.jpg\')">Photo 2</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-donation-3.jpg\')">Photo 3</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-donation-4.jpg\')">Photo 4</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-donation-5.jpg\')">Photo 5</button><br>2024.10 Honorary President, 34th Parents&#39; Association<br>2022.10-2024.10 President of the 32nd and 33rd Parents&#39; Association<br>Starting from the 113th Academic Year, the Honorary PTA President\'s Award will be presented to graduating students <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-president-award.jpg\')">Photo</button>',
