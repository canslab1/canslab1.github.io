...
const alumniArticleZh = [
    '余等謹此誠摯推薦民國71年第37屆畢業生黃崇源教授作為臺北市老松國小創校130週年校慶傑出校友貢獻獎之表揚人選。黃教授現任長庚大學資訊工程學系教授，並曾任所羅門股份有限公司獨立董事，長期致力於人工智慧領域之學術研究和人才培育，曾於2024年同時榮獲中國科技大學傑出校友及臺北市杏壇芬芳錄兩項肯定並公開表揚，近年返回母校擔任學生家長會會長、榮譽會長。時至今日，始終秉持食果子拜樹頭、食米飯拜田頭的初衷，感謝母校恩師的極力栽培和持續鼓勵，並竭力協助可愛的學弟妹及尊敬的師長，其事蹟可謂楷模，誠為本獎最具代表性的候選人。',
...
const bioZh = [
    '黃崇源博士（1970年8月13日生）擔任多項職務，包括大學教授、資訊科學家、醫學中心研究員，並曾任上市公司獨立董事。黃博士目前居住在臺北市萬華區，擔任長庚大學資訊工程學系教授，同時兼任人工智慧學程與研究所、人工智慧研究中心合聘教授等職務。',
    '1985年，他考入中國工商專校電子資料處理科，在全職工作的同時，歷經七年半工半讀完成學士學位。畢業後，他在澎湖防衛司令部服義務兵役，然後在宇博電腦（臺灣）股份有限公司擔任四年的軟體工程師。1998年，他考取新竹國立交通大學計算機資訊科學所，並於2000年與2005年分別獲頒碩士和博士學位。在攻讀博士學位期間，擔任中國科技大學資訊工程學系專任講師。2006年，他被授予中華民國斐陶斐學會學術榮譽會員資格。獲得博士學位後，黃崇源在元培科技大學資訊工程學系擔任一學年的專任助理教授，並兼任系主任和生物醫學資訊技術學群的副執行長。自2006年起，黃博士擔任長庚大學資訊工程學系專任助理教授，兼任資訊中心教學服務組組長。2010年升等副教授，2015年升等正教授。自2019年8月起，他在長庚紀念醫院神經內科擔任聯合聘任研究員。',
    '黃博士目前的研究興趣包括複雜系統計算建模與模擬、社會建模與模擬及流行病傳播動力學。他的研究結合了遺傳演算法、學習分類系統、複雜網絡分析等人工智慧方面的最新研究成果。他的第一篇學術論文（關於SARS傳播動態與公衛政策模擬）發表在2004年的學術期刊JASSS上。此後，他發表了171篇學術論文，其中45篇發表於SCI/SSCI/EI等級期刊，49篇發表在國際會議論文集上，10篇發表在書籍章節中，67篇發表在國內會議論文和大眾報紙專欄文章中。根據Google Scholar的統計，截至2026年2月，他發表的論文被引用994次（其中30篇每篇被引用10次以上），h-index為18。'
];

const bioEn = [
    'The many roles played by Chung-Yuan Huang, Ph.D. (b. August 13, 1970) include university professor, information scientist, medical center research fellow, and former independent director of a publicly listed company. Currently residing in the Wanhua District of Taipei, Dr. Huang is a full professor in the Department of Computer Science and Information Engineering at Chang Gung University, concurrently holding a joint appointment as professor in the Artificial Intelligence undergraduate program and research institute, and the Artificial Intelligence Research Center.',
