...
const honorsZh = [
    ...
    '<span class="honors-highlight">臺北市立龍山國民中學</span><br>2026.04 捐資母校，獲頒感謝狀 <button class="interview-btn" onclick="showImageModal(\'images/honors/longshan-donation-1.webp\')">照片一</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/longshan-donation-2.webp\')">照片二</button><br>113 學年起，擔任學生家長會顧問',
    '<span class="honors-highlight">臺北市老松國民小學</span><br>2026.04 榮獲傑出校友<br>2026.04 獲頒 130 周年校慶金質獎感謝狀<br>2026.03 榮膺 115 年校務顧問 <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-advisor.webp\')">照片一</button><br>2025.10 教師節捐款新台幣伍拾萬元整 <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-donation-1.webp\')">照片一</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-donation-2.webp\')">照片二</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-donation-3.webp\')">照片三</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-donation-4.webp\')">照片四</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-donation-5.webp\')">照片五</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-donation-6.webp\')">照片六</button><br>111 學年起，連續四學年捐款總額超過新臺幣壹佰萬元整',
