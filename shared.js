...
const honorsZh = [
    '<span class="honors-highlight">中國科技大學</span><br>2024.11 榮獲傑出校友 <button class="interview-btn" onclick="showVideoModal(\'028zexOcXZo\')">專訪</button><br>2000.11 榮獲優秀校友<br>校史唯一先後獲頒傑出與優秀校友',
    '<span class="honors-highlight">臺北市杏壇芬芳獎</span><br>2024.11 榮獲臺北市教育局公開表揚 <button class="interview-btn" onclick="showImageModal(\'images/honors/cute-alumni-group.jpg\')">照片一</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/cute-distinguished-alumni.jpg\')">照片二</button>',
...
const honorsEn = [
    '<span class="honors-highlight">China University of Technology</span><br>2024.11 Distinguished Alumni Award <button class="interview-btn" onclick="showVideoModal(\'028zexOcXZo\')">Interview</button><br>2000.11 Outstanding Alumni Award<br>the only recipient in university history of both Distinguished and Outstanding Alumni honors.',
    '<span class="honors-highlight">2024.10 Taipei Honored Contributors to Education</span><br>Bottomless Devotion to Taipei Lao-Song Elementary School <button class="interview-btn" onclick="showImageModal(\'images/honors/cute-alumni-group.jpg\')">Photo 1</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/cute-distinguished-alumni.jpg\')">Photo 2</button>',
