...
const honorsZh = [
    ...
    '<span class="honors-highlight">臺北市老松國民小學學生家長會</span><br>2025.10 教師節捐款新台幣伍拾萬元整 <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-donation-1.jpg\')">照片一</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-donation-2.jpg\')">照片二</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-donation-3.jpg\')">照片三</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-donation-4.jpg\')">照片四</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-donation-5.jpg\')">照片五</button><br>2024.10 榮膺第 34 屆榮譽會長 <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-honorary-president.jpg\')">照片</button><br>2023.10 擔任臺北市小聯會常務理事 <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-xlh-delegates.jpg\')">照片一</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-xlh-board.jpg\')">照片二</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-xlh-election.jpg\')">照片三</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-xlh-west-district.jpg\')">照片四</button><br>2022.10 擔任第 32 和 33 屆會長<br>113 學年起設立畢業生榮譽會長獎，每班壹名，鼓勵多元學習表現優異學童 <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-president-award.jpg\')">照片</button><br>111 學年起，連續四學年捐款總額超過新臺幣壹佰萬元整',
    '<span class="honors-highlight">所羅門股份有限公司</span><br>2022.06 榮膺第十二屆董事會獨立董事 <button class="interview-btn" onclick="showImageModal(\'images/honors/solomon-newyear.jpg\')">照片一</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/solomon-shareholders.jpg\')">照片二</button><br>2022.06 擔任薪酬、審計、永續發展委員',
    '<span class="honors-highlight">中華民國斐陶斐榮譽學會獎</span><br>2006.06 榮獲國立交通大學公開頒發 <button class="interview-btn" onclick="showImageModal(\'images/honors/ptphs-family.jpg\')">照片一</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/ptphs-ceremony.jpg\')">照片二</button><br>表彰卓越學術成就與優異品德操守'
];
...
const honorsEn = [
    ...
    '<span class="honors-highlight">Laosong Elementary School, Taipei City</span><br>2025.10 Donated NT$500,000 on Teachers&#39; Day <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-donation-1.jpg\')">Photo 1</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-donation-2.jpg\')">Photo 2</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-donation-3.jpg\')">Photo 3</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-donation-4.jpg\')">Photo 4</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-donation-5.jpg\')">Photo 5</button><br>2024.10 Honorary President, 34th Parents&#39; Association <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-honorary-president.jpg\')">Photo</button><br>2023.10 Standing Director of Taipei Elementary School PTA Federation <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-xlh-delegates.jpg\')">Photo 1</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-xlh-board.jpg\')">Photo 2</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-xlh-election.jpg\')">Photo 3</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-xlh-west-district.jpg\')">Photo 4</button><br>2022.10-2024.10 President of the 32nd and 33rd Parents&#39; Association<br>Starting from the 113th Academic Year, the Honorary PTA President\'s Award will be presented to graduating students <button class="interview-btn" onclick="showImageModal(\'images/honors/laosong-president-award.jpg\')">Photo</button><br>Since the 111th Academic Year, cumulative donations over four consecutive years exceeded NT$1,000,000',
    '<span class="honors-highlight">Solomon Technology Corporation</span><br>2022.06 Served as Independent Director on the 12th Board of Directors of Solomon Co., Ltd. <button class="interview-btn" onclick="showImageModal(\'images/honors/solomon-newyear.jpg\')">Photo 1</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/solomon-shareholders.jpg\')">Photo 2</button><br>2022.06 Served on the Compensation, Audit, and Sustainability Committees of the 12th Board of Directors of Solomon Co., Ltd.',
    '<span class="honors-highlight">Phi Tau Phi Honor Award</span><br>2006.06 Awarded by National Chiao Tung University, <button class="interview-btn" onclick="showImageModal(\'images/honors/ptphs-family.jpg\')">Photo 1</button> <button class="interview-btn" onclick="showImageModal(\'images/honors/ptphs-ceremony.jpg\')">Photo 2</button><br>in recognition of academic excellence and exemplary character'
];
...
const bioZh = [
    ...
    '黃博士目前的研究興趣包括複雜系統計算建模與模擬、社會建模與模擬及流行病傳播動力學。他的研究結合了遺傳演算法、學習分類系統、複雜網絡分析等人工智慧方面的最新研究成果。他的第一篇學術論文（關於SARS傳播動態與公衛政策模擬）發表在2004年的學術期刊JASSS上。此後，他發表了172篇學術論文，其中44篇被SCI/SSCI收錄，50篇發表在國際會議論文集上，10篇發表在書籍章節中，68篇發表在國內會議論文和大眾報紙專欄文章中。根據Google Scholar的統計，截至2026年2月，他發表的論文被引用994次（其中30篇每篇被引用10次以上），h-index為18。'
];
