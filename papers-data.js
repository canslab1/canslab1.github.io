...
const papersData = [
    {
        ...
        periods: [
            ...
            'Fu Y.H., Huang C.Y.*, and Sun C.T. (2015) Identifying Super-Spreader Nodes in Complex Networks. Mathematical Problems in Engineering, vol. 2015, Article ID 675713, 8 pages. https://doi.org/10.1155/2015/675713. (SCI, IF: 0.644, Rank 59/85 [70%] in Engineering, Multidisciplinary)',
    ...
    },
    {
        ...
        periods: [
            ...
            'Huang C.Y., Sun C.T., Cheng C.Y., and Tsai Y.S. (2008) Resource, Costs and Epidemic Critical Thresholds in Scale-Free Social Networks. In Proceedings of IEEE 7th World Congress on Intelligent Control and Automation (WCICA’08), Chongqing, China, 1874-1879.',
            ...
            'Huang C.Y., Hsieh J.L., Sun C.T., and Shih F.M. (2007) Mining Domain Ontological Information from Online Publications. In Proceedings of 6th WSEAS International Conference on E-Activities (E-ACTIVITIES’07), Puerto De La Cruz, Tenerife, Canary Islands, Spain, 153-158.',
