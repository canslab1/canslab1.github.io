...
const papersData = [
    {
        ...
        periods: [
            ...
            'Huang C.Y., Chin W.C.B., Fu Y.H., and Tsai Y.S. (2019) Beyond Bond Links in Complex Networks: Local Bridges, Global Bridges and Silk Links. Physica A: Statistical Mechnics and Its Applications, 536, 121027. https://doi.org/10.1016/j.physa.2019.04.263. (SCI, IF: 2.924, Rank: 26/85 [30%] in Physics, Multidisciplinary, EI)',
            ...
            'Fu Y.H., Huang C.Y.*, and Sun C.T. (2016) Using a Two-Phase Evolutionary Framework to Select Multiple Network Spreaders Based on Community Structure. Physica A: Statistical Mechnics and Its Applications, 461, 840-853. https://doi.org/10.1016/j.physa.2016.06.042. (SCI, IF: 2.243, Rank: 18/79 [23%] in Physics, Multidisciplinary, EI)',
            ...
            'Lee C.L., Huang C.Y.*, Hsiao T.C., Wu C.Y., Chen Y.C, and Wang I.C. (2014) Impact of Vehicular Networks on Emergency Medical Services in Urban Aras. International Journal of Environmental Research and Public Health, 11(11), 11348-11370. https://doi.org/10.3390/ijerph111111348. (SCI, IF: 2.035, Rank: 101/225 [45%] in Environmental Sciences)',
            ...
            'Huang C.Y., Tsai Y.S., Sun C.T., Hsieh J.L., and Cheng C.Y. (2009) Influences of Resource Limitations and Transmission Costs on Epidemic Simulation and Critical Thresholds in Scale-Free Networks. Simulation: Transactions of the Society for Modeling and Simulation International, 85(3), 205-219. https://doi.org/10.1177/0037549709352197. (SCI, IF: 0.640, Rank: 77/106 [73%] in Computer Science, Software Engineering, EI)',
